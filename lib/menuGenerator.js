 ...
 *   ingredients[]   - Array de ingredientes (ATENCIÓN: receta id=10 usa la
 *                     clave "ingredientes" en vez de "ingredients")
 *   img             - Ruta de la imagen
 *   gym             - booleano (ids 22, 24). NO SE USA en la lógica actual
 *
 ...
 *
 * 5. INCONSISTENCIA "ingredients" vs "ingredientes"
 *    La receta id=10 usa la clave "ingredientes". Aunque resolveIngredients
 *    lo maneja con fallback (recipe.ingredients || recipe.ingredientes),
 *    es una inconsistencia que podría romperse si se refactoriza.
 *
 * 6. CAMPO "gym" NO UTILIZADO
 *    Las recetas 22 y 24 tienen "gym": true pero no hay lógica que lo use.
 *    Campo residual o feature no implementada.
 *
 * =============================================================================
 */
