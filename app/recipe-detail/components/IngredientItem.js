...
export default function IngredientItem({ ingredient }) {
  ...
  return (
    <label className="flex items-start gap-sm p-sm rounded-xl">
      ...
      <div className="flex-1 flex items-center gap-sm transition-all duration-300">
        <div className="w-6 h-6 rounded-full border-2 border-outline-variant flex items-center justify-center peer-checked:bg-primary peer-checked:border-primary transition-colors mt-0.5 shrink-0 relative overflow-hidden">
